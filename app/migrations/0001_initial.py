...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_cfauser', (
            ...
            ('funder_name', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('user_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('osa_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('mission_statement', self.gf('django.db.models.fields.TextField')(max_length=256, blank=True)),
        ))
        db.send_create_signal('app', ['CFAUser'])

        # Adding M2M table for field cc_emails on 'CFAUser'
        db.create_table('app_cfauser_cc_emails', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cfauser', models.ForeignKey(orm['app.cfauser'], null=False)),
            ('ccemail', models.ForeignKey(orm['app.ccemail'], null=False))
        ))
        db.create_unique('app_cfauser_cc_emails', ['cfauser_id', 'ccemail_id'])
        ...
        db.create_table('app_grant', (
            ...
            ('amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=2)),
        ))
        ...
        # Adding model 'CCEmail'
        db.create_table('app_ccemail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
        ))
        db.send_create_signal('app', ['CCEmail'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field cc_emails on 'CFAUser'
        db.delete_table('app_cfauser_cc_emails')
        ...
        # Deleting model 'CCEmail'
        db.delete_table('app_ccemail')
    ...
    models = {
        ...
        'app.cfauser': {
            ...
            'cc_emails': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['app.CCEmail']", 'symmetrical': 'False'}),
