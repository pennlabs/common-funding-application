    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "funder_name",
                    models.CharField(default="", max_length=256, blank=True),
                ),
                (
                    "user_type",
                    models.CharField(
                        max_length=1, choices=[("R", "REQUESTER"), ("F", "FUNDER")]
                    ),
                ),
                (
                    "osa_email",
                    models.EmailField(
                        ...
                        max_length=75,
                        null=True,
                        verbose_name="OSA Contact Email",
                        blank=True,
                    ),
                ),
                ...
                (
                    "cc_emails",
                    models.ManyToManyField(to="app.CCEmail", null=True, blank=True),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "answer",
                    models.CharField(max_length=1, choices=[("Y", "YES"), ("N", "NO")]),
                ),
            ],
            options={},
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(default=0, max_digits=17, decimal_places=2),
                ),
                (
                    "status",
                    models.CharField(
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="event_applied_funders", to="app.CFAUser"
                    ),
                ),
                (
                    "requester",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "funder",
                    models.ForeignKey(to="app.CFAUser", on_delete=models.CASCADE),
                ),
            ],
            options={
                "abstract": False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question",
                    models.ForeignKey(
                        to="app.EligibilityQuestion", on_delete=models.CASCADE
                    ),
                ),
            ],
            options={},
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "amount",
                    models.DecimalField(null=True, max_digits=17, decimal_places=2),
                ),
                (
                    "funder",
                    models.ForeignKey(to="app.CFAUser", on_delete=models.CASCADE),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price_per_unit",
                    models.DecimalField(max_digits=17, decimal_places=2),
                ),
                (
                    "funding_already_received",
                    models.DecimalField(max_digits=17, decimal_places=2),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                to="app.FreeResponseQuestion", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            name="question",
            field=models.ForeignKey(
                to="app.FollowupQuestion", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
        ...
        migrations.AddField(
            ...
            name="question",
            field=models.ForeignKey(
                to="app.CommonFreeResponseQuestion", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="question",
            field=models.ForeignKey(
                to="app.CommonFollowupQuestion", on_delete=models.CASCADE
            ),
            preserve_default=True,
        ),
        migrations.AddField(
