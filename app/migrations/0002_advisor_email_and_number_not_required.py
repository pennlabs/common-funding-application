...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.advisor_phone'
        db.alter_column('app_event', 'advisor_phone', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Event.contact_phone'
        db.alter_column('app_event', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Event.advisor_phone'
        db.alter_column('app_event', 'advisor_phone', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Event.contact_phone'
        db.alter_column('app_event', 'contact_phone', self.gf('django.db.models.fields.CharField')(max_length=10))
