...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.over'
        db.delete_column('app_event', 'over')

        # Adding field 'Event.status'
        db.add_column('app_event', 'status',
                      self.gf('django.db.models.fields.CharField')(default='S', max_length=1),
                      keep_default=False)


        # Changing field 'Grant.amount'
        db.alter_column('app_grant', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=17, decimal_places=2))

    def backwards(self, orm):
        # Adding field 'Event.over'
        db.add_column('app_event', 'over',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Event.status'
        db.delete_column('app_event', 'status')


        # Changing field 'Grant.amount'
        db.alter_column('app_grant', 'amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=17, decimal_places=2))
