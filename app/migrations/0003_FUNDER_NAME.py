...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CFAUser.name'
        db.delete_column('app_cfauser', 'name')

        # Adding field 'CFAUser.funder_name'
        db.add_column('app_cfauser', 'funder_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CFAUser.name'
        db.add_column('app_cfauser', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Deleting field 'CFAUser.funder_name'
        db.delete_column('app_cfauser', 'funder_name')
